...
36. Создаём рабочую версию приложения:
   ...
   *Если на этапе сборки терминал зависает, необходимо на этап сборки увеличить размер памяти RAM на сервере [REG.RU](https://cloud.reg.ru/panel/) до 4 ГБ*
      ...
      -  В браузере заходим на [облачное хранилище](https://cloud.reg.ru/panel/);
      -  Выбираем созданный ранее сервер;
      -  Нажимаем кнопку **••• Ещё** и выбираем **Изменить тариф**;
      -  В сплывающем окне выбираем **Своя конфигурация**;
      -  Ниже меняем **Размер памяти RAM** до 4 ГБ.
